...
# Create a secure, anonymized hash of the Chat ID for public tracking
        ...
        try:
            with open(tracker_file, "r", encoding="utf-8") as f:
                ...
                if saved_data.get("date") == today_str:
                    ...
                    usage_data["users"] = saved_data.get("users", {})
        except Exception:
            pass
...
# Ensure current user is initialized in today's tracker
