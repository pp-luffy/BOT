...
2. For multi-statement questions (e.g., "Consider the following statements"): Establish the absolute truth value of EACH statement independently BEFORE evaluating the options. Watch for nuanced terminology errors.
